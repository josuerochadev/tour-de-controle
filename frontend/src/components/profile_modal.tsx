			...
			>
				<div className="bg-paper-soft rounded-3xl p-6 w-80 border border-sand">
					<div className="flex justify-between items-center mb-4">
						<h2 id="profile-title" className="font-display text-sm font-semibold tracking-wider uppercase text-ink">Mon profil</h2>
						<button
							ref={closeButtonRef}
							type="button"
							aria-label="Fermer le profil"
							onClick={onClose}
							className="text-ink-4 hover:text-signal bg-transparent border-none cursor-pointer text-lg"
						>
							&#x2715;
						</button>
					</div>
